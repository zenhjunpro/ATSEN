    ...
    for epoch in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step+1)%args.gradient_accumulation_steps == 0:
                ...
                # else:
                _update_mean_model_variables_v4(model_s1, model_t1, args.mean_alpha, global_step,t_total,args.al)
                _update_mean_model_variables_v4(model_s2, model_t2, args.mean_alpha, global_step,t_total,args.al)
